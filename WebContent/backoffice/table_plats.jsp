...
<head>
  ...
  <title>DashBoard - Table Plats</title>
          ...
          <div class="panel-body">
            <form class="form-horizontal " method="post" action="BoCreatePlat">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input class="form-control" id="disabledInput" type="text" placeholder="N/A" disabled="">
                </div>
              </div>
              <div class="form-group">
          ...
          <table class="table table-striped table-advance table-hover">
            <tbody>
              <tr>
                ...
                <th><i class="icon_menu-square_alt2"></i> Label</th>
                <th><i class="icon_menu-square_alt2"></i> Description</th>
